...
require_once("index_header.php");
	$user=sesiones_start();
	librerias();
	scripts_head("../Clases/javascript/busqueda_moneda.js");
	encabezado();
?>
...
<p></p>
 <div>
 	...
 	Buscar:<INPUT type="text" id="search" onKeyUp="Pagina('1')"><a id="add_Moneda" href="moneda_registro.php"  title="Registro Moneda"><img src='../imagenes/add.png' style="alignment-adjust:middle;" /></A></div>
 <div id="sentencias" class="content">
 <?
 	require_once("../Clases/Conexion/conexion_prueba_local.php");
	require_once("../Clases/Objetos/moneda.php");
	$link=conect();
	$moneda=new moneda();
	...
	$RegistrosAEmpezar=0;
	$PagAct=1;
	$array=$moneda->busqueda_parametros("", $RegistrosAEmpezar, $RegistrosAMostrar);
