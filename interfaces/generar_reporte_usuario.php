...
$datos='';
$cabecera='';
$registros=mysql_query("SELECT usuario.usuario_id, domicilio.domicilio_calle, domicilio.domicilio_colonia, domicilio.domicilio_num_ext, domicilio.domicilio_num_int, domicilio.domicilio_municipio, domicilio.domicilio_ciudad, domicilio.domicilio_estado , domicilio.domicilio_cp FROM usuario,domicilio WHERE (usuario_id LIKE '%$name%' or domicilio_municipio like '%$name%' or domicilio_estado like '%$name%' ) and usuario.domicilio_id = domicilio.domicilio_id;",$conexion)or die(mysql_error());
...
$cabecera =  str_replace ( 'usuario.usuario_id' ,  'USUARIO' ,  $cabecera );
