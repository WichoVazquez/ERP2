...
?>
	...
	$array=$pantalla->obtiene_pantalla($_SESSION["perfil"],"PRODUCCIÓN");
    ...
    $cont=0;
		for($renglones=0; $renglones<count($array);$renglones++)
		{
			...
			crea_article($array[$renglones][0],$array[$renglones][2],"",$array[$renglones][1]);	
					...
					/*
crea_article("taller_ordenes_salida.php","orden","", "ORDENES DE SALIDA");
crea_article("taller_solicitud_material.php","pantalla","", "SOLICITUDES DE MATERIAL");
crea_article("taller_vales_consumo.php","noticias","", "VALES DE CONSUMO");
