...
$datos='';
$cabecera='';
$registros=mysql_query("SELECT * FROM proveedor WHERE proveedor_rs LIKE '%$name%' or proveedor_rfc like '%$name%';",$conexion) or
  die(mysql_error());
...
$cabecera =  str_replace ( 'proveedor_rs' ,  'RAZON_SOCIAL' ,  $cabecera );
$cabecera =  str_replace ( 'proveedor_rfc' ,  'RFC' ,  $cabecera );
$cabecera =  str_replace ( 'domicilio_id' ,  'DOMICILIO' ,  $cabecera );
$cabecera =  str_replace ( 'generales_id' ,  'ID' ,  $cabecera );
}
