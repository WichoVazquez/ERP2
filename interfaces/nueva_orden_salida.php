...
require_once("index_header.php");
  $user=sesiones_start();
  librerias();
  scripts_head("../Clases/javascript/nueva_ordensalida.js");
...
<h1>Datos de la Cotizacion No. <INPUT  name="id_cot" id="id_cot"  readonly style="width:60px;" IDCOTBUSCA="null" value=""/>
</h1>    
...
<?
  ...
  $array=$orden_salida->nuevo_folio();
...
<TABLE >
    ...
    <TBODY>
  <td><img src='../imagenes/pedidos1.png'  height="400" width="550" /></td>
  <td><img src='../imagenes/pedidos2.png'  height="400" width="550" /></td>
    </TBODY>
  </TABLE>
