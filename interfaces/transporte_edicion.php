...
<body>
 ...
 <?php
		...
		if(!isset($_POST['Guardar']))
		{
			...
			$provarray=$transporte->detalle($id);
			
			
			echo  "
  			<form  method='post' name='myform' id='myform' action=\"transporte_edicion.php?id=".$id."&placas=".$provarray[2]."\">
			
				 <span class='Titulo'>Editar Transporte</span>
				 <div id='separa3'></div>
     ...
     <tr>  
		...
		$_GET['placas']);
					...
					{		
								...
								echo "<br>
						   		<p id='text' class='texto_subtitulo' style='padding-top:20px;font-size:22px;'>El Transporte ha sido actualizado</p>";
							}
							else
							{
								echo "
								<br>
								<p id='text' class='texto_subtitulo' style='padding-top:20px;font-size:22px;'>ERROR:El Transporte no se ha podido actualizar </p>";
							}
