...
require_once("index_header.php");
  $user=sesiones_start();
  librerias();
  scripts_head("../Clases/javascript/nueva_recoleccionequipo.js");
...
<H2>
<a  href="recoleccion_equipo_busqueda_usuario.php"  title="Regresar"  style="text-decoration:none;">
        <img src='../imagenes/back-imagen.png'  height="30" width="30" /> 
        </a>
  Registro de Recolección de Equipo en Bitácora</H2>
<DIV id="varcot">
<?
...
echo "<input id='pedidono' value='0'/>";
...
<DIV id="orders-contain_cotizacion" class="ui-widget">
  ...
  <h1>Datos de la Cotizacion No.   <INPUT  name="id_cot" id="id_cot"  readonly style="width:60px;" IDCOTBUSCA="null" value=""/> </h1>    
...
<tr>
    ...
    <td  style="width:100px;"> 
        <INPUT type="text" name="empresa_cot" id="empresa_cot"  readonly style="width:300px; background-color:#D3D3D3;" IDEMPRESACOT="null" value=""/>
    </td>
  ...
  <LABEL style="width:100px;" for="cliente_cot">Cliente:</LABEL>
    ...
    <td  style="width:100px;"> 
      <INPUT type="text" name="cliente_cot" id="cliente_cot"  readonly style="width:300px; background-color:#D3D3D3;" IDCLIENTECOT="null" value=""/>
...
<table>
  ...
  <td width='100px'>
           <INPUT type="text" name="folio_OS" id="folio_OS" class="ui-widget-content"  style="width:100px;" FOLIOOBS="null" value=""/>
    </td>
...
<td width='200px'>
<input name="datepicker1" class="ui-widget-content" readonly style="width:100px;"  type="text" id="datepicker1" />

    </td>
  <td width='300px'>
        <LABEL class="ui-widget" for="datepicker2"> Fecha de Recolección:
  </td>
       

 <td width='200px'>

<input name="datepicker2" class="ui-widget-content" readonly style="width:100px;"  type="text" id="datepicker2" />
...
<BUTTON id="agregar-detalle-cot">AGREGAR DETALLE COTIZACION</BUTTON> |
...
<BUTTON id="Guardar-Borrador">Guardar</BUTTON> |
   <BUTTON id="Guardar">Confirmar Recolección de Equipo</BUTTON> |
...
<DIV id="dialog-form" title="Ingresar Producto" height="700">
  ...
  <FIELDSET>
    ...
    <br>
    <LABEL style="width:50px;" for="cantidad_prestamo">Cantidad en Préstamo:</LABEL>
    <INPUT type="text" name="cantidad_prestamo" id="cantidad_prestamo" class="text ui-widget-content ui-corner-all"  value="0"  style="width:100px;" />
