...
<a  href="TRAFICO.php"  title="Regresar"  style="text-decoration:none;">
				...
				Búsqueda de Notas de Salida por Ruta</h2>
<p></p>
 ...
 <?
	...
	$PagAct=1;
	$filter=-1;
	$array=$logistica->busqueda_parametros_notas_salida("", $RegistrosAEmpezar, $RegistrosAMostrar, $filter);
    ;
	if($array!=null)
	{	
		 //echo "".count($array);
	...
	//				{
								...
								echo "<td><a class='editEntrega' href='edicion_notas_salida_sumario.php?id=".$array[$renglones][0]."&idTransporte1=".$array[$renglones][3]."' style='text-decoration:underline;'>".$array[$renglones][2]."</a></td>";
