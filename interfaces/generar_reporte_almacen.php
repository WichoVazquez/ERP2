...
$datos='';
$cabecera='';
$registros=mysql_query("SELECT almacen.almacen_id, almacen.nombre, almacen.descripcion, domicilio.domicilio_calle, 
  ...
  domicilio.domicilio_estado , domicilio.domicilio_cp  from almacen,domicilio WHERE (almacen.almacen_id LIKE '%$name%' or almacen.nombre like '%$name%') and 
  almacen.domicilio_id= domicilio.domicilio_id ;",$conexion) or
  die(mysql_error());
...
$cabecera =  str_replace ( 'almacen_id' ,  'CLAVE' ,  $cabecera );
$cabecera =  str_replace ( 'nombre' ,  'NOMBRE' ,  $cabecera );
