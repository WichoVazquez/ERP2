...
<body>
 ...
 <?php
	...
	*/	
		...
		{
			echo "  <form  method='post' name='myform'  id='myform'  onsubmit=\"return validarDatosTransporte(true)\" action='remolque_registro.php'>
			 <span class='Titulo'>Registro de Remolque</span>
			 <div id='separa3'></div>
	  ...
	  <tr>  
		...
		$result_insert=$transporte->insert_remolque(
		$_POST['nombre'],
		$_POST['placas']);
		//echo  $result_insert;
		if($result_insert!=0)
				...
				{
					echo "<br>
						   <p id='text' class='texto_subtitulo' style='padding-top:20px;font-size:22px;'>El Remolque ha sido registrado</p>";
				}
				else
				{
					echo  "
							<br>
							<p id='text' class='texto_subtitulo' style=' padding-top:20px;font-size:22px;'>ERROR: El Remolque no se ha podido registrar</p>";
