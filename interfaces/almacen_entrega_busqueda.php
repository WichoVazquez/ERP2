 ...
 <?
	...
	{	
		...
		for($renglones=0; $renglones<count($array);$renglones++)
		{
					...
					{echo "<td><a class='editEntrega' href='edicion_entrega.php?id=".$array[$renglones][0]."&idTransporte1=".$array[$renglones][3]."' style='text-decoration:underline;'><img src=\"../imagenes/b_edit.png\" title=\"Editar Entrega\"/></a></td>";
