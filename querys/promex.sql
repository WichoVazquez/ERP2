...
--
-- Host: localhost
-- Generation Time: Jul 31, 2013 at 09:27 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='tabla ALMACEN_MATERIAL' AUTO_INCREMENT=14 ;
...
('1', 'CORPORATIVO DESCI SA DE CV', 'CDE040218486', 62),
('10', 'GOBIERNO DEL DISTRITO FEDERAL', 'GDF9712054NA', 55),
('11', 'GOBIERNO DEL DISTRITO FEDERAL/SECRETARIA DE SALUD', 'GDF9712054NA', 56),
('12', 'GOBIERNO DEL DISTRITO FEDERAL', 'GDF9712054NA', 57),
('13', 'GOBIERNO DEL DISTRITO FEDERAL, G.D.F.', 'GDF9712054NA', 58),
('14', 'INSTITUTO NACIONAL DE PEDIATRIA', 'INP8304203F7', 59),
('15', 'FRANCISCO BRAVO SÁNCHEZ', 'XXXXXXXXXXXX', 60),
('2', 'SUPERISSSTE', 'SUP090821742', 47),
('3', 'Mogel Fluídos, S.A. DE C.V.', 'PEX961112RA5', 48),
('4', 'ASAMBLEA LEGISLATIVA DEL DISTRITO FEDERAL', 'ALD971028S24', 49),
('5', 'GOBIERNO DEL DISTRITO FEDERAL EN VENUSTIANO CARRAN', 'GDF9712054NA', 50),
('6', 'SECRETARIA DEL MEDIO AMBIENTE, G.D.F.', 'GDF9712054NA', 51),
('7', 'INSTITUTO NACIONAL DE ANTROPOLOGIA E HISTORIA', 'INA460815GV1', 52),
('8', 'INSTITUTO FEDERAL ELECTORAL', 'IFE901011IH1', 53),
('9', 'GOBIERNO DEL DISTRITO FEDERAL/SECRETARIA DE FINANZ', 'GDF9712054NA', 54);
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla de Cotizaciones' AUTO_INCREMENT=349 ;
...
(320, 2, '1', 'usuario1', 1, 1, '2013-07-30 17:21:24', '2013-07-30 12:21:24', 1, 1.00, '', 1, ''),
...
(331, 2, '1', 'usuario1', 1, 7, '2013-07-18 23:39:22', '2013-07-18 18:39:22', 1, 1.00, '', 1, ''),
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='DETALLE COTIZACION' AUTO_INCREMENT=219 ;
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `empresa_domicilio_fiscal` varchar(200) NOT NULL,
...
(1, 'MOGEL FLUÍDOS SA DE CV', 'prom111111111', 'ARAGÃ“N'),
(2, 'EMPRESA2', 'ASFD999999999', 'ARAGÃ“N');
...
`material_maquila` tinyint(1) DEFAULT NULL COMMENT 'si esta seleccionado significa que pertenece a taller',
  

PRIMARY KEY (`material_id`)

) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='tabla Material' AUTO_INCREMENT=16 ;
...
(7, 'material1', 3, 1, 150,1),
(8, 'material2', 2, 1, 20,1),
(9, 'Almacen2', 1, 2, 0,0),
(10, 'material1', 1, 2, 0,0),
(11, 'Almacen2', 3, 5, 400,0),
(12, 'Almacen2', 3, 2, 0,0),
(13, 'Refacciones', 3, 3, 0,0),
(14, 'Cilindro', 3, 3, 0,0),
(15, 'Camillas', 2, 3, 0,0);
...
INSERT INTO `moneda` (`Moneda_Id`, `Descripcion`, `Prefijo`, `TipoCambio`) VALUES
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla RUTA' AUTO_INCREMENT=50 ;
-- --------------------------------------------------------
...
INSERT INTO `transporte` (`Transporte_Id`, `Nombre`, `Placas`) VALUES
(1, 'Rabon1', ' 111-222');
...
ALTER TABLE COTIZACION ADD COLUMN cotizacion_recotizada bigint(20) NULL;

ALTER TABLE `COTIZACION`
  ADD CONSTRAINT `cotizacion_recotizacion_ibfk_1` FOREIGN KEY (`cotizacion_recotizada`) REFERENCES `cotizacion` (`cotizacion_id`);
