<?
			...
			$id=$_POST['search'];
			$cliarray=$cliente->detalle($id);
			$array=$domicilio->detalle($cliarray[3]);
			...
			echo "<td class='texto_chico_tabla' width='100' style='font-size:12px;'>".$cliarray[1]."</td>";
			echo "<td class='texto_chico_tabla' width='100' style='font-size:12px;font-weight: bold;'>R.F.C.:</td>";
			echo "<td class='texto_chico_tabla' width='100' style='font-size:12px;'>".$cliarray[2]."</td>";		
			echo "</tr>";
			echo "<tr class='texto_chico_tabla' width='100' style='font-size:12px;'>";
