<?
	...
	$array=$almacen->busqueda_parametros($id, $RegistrosAEmpezar, $RegistrosAMostrar);
	;
	if($array!=null)
	{	
	 //echo "".count($array);
	...
	{
				echo "<tr>";
							echo "<td><a class='editAlm' href=\"javascript:editar('".$array[$renglones][0]."',1)\" idedit=".$array[$renglones][0]." style='text-decoration:underline;'><img src=\"../imagenes/b_edit.png\"  title=\"Editar Almacen\"/></a></td>";
							echo"<td><a class='delAlm' href=\"javascript:eliminar('".$array[$renglones][0]."',1)\" idedit=".$array[$renglones][0]." style='text-decoration:underline;'><img src=\"../imagenes/b_drop.png\" title=\"Eliminar Almacen\"/></a></td>";
