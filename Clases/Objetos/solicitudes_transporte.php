      ...
      class Solicitud_transporte
        {
          ...
          function InsertTransportes(// no incluyo ni estado, ni fecha de envio debido a que estas variables seran actualizadas una vez el proceso de llenado de cotizacion
          ...
          function busqueda_parametros($search, $inicio, $fin, $filter)
          {
                  ...
                  FROM LABORATORIO, MATERIAL, DETALLE_PEDIDO  WHERE LABORATORIO.id_detalle=DETALLE_PEDIDO.detalle_pedido_id AND DETALLE_PEDIDO.producto_id = MATERIAL.material_id 
                   " ;
                  if(!empty($search))
                  {
                   $sql=$sql."";
