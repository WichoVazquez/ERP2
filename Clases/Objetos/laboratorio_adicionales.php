      ...
      class Laboratorio_adicionales
        {
          ...
          {
                  $sql = "UPDATE LABORATORIO_ADICIONALES set  
                  ...
                  if($certificado!="")
                   ...
                   $sql=$sql." WHERE id_laboratorio_adicional=".$id_laboratorio."";
          ...
          function busqueda_parametros($search, $inicio, $fin, $filter)
          {
                  ...
                  $sql="SELECT
                  LABORATORIO_ADICIONALES.id_laboratorio_adicional,
                  LABORATORIO_ADICIONALES.tipo_orden,
                  LABORATORIO_ADICIONALES.id_producto,
                  LABORATORIO_ADICIONALES.cantidad,
                  LABORATORIO_ADICIONALES.cantidad_rev,
                  LABORATORIO_ADICIONALES.id_usuario,
                  LABORATORIO_ADICIONALES.id_usuario_rev,
                  DATE(LABORATORIO_ADICIONALES.fecha_ini),
                  DATE(LABORATORIO_ADICIONALES.fecha_rev),
                  LABORATORIO_ADICIONALES.status,
                  MATERIAL.material_descripcion,
                  LABORATORIO_ADICIONALES.certificado,
                  UNIDADES.prefijo,
                  LABORATORIO_ADICIONALES.lote
                  FROM LABORATORIO_ADICIONALES, MATERIAL, UNIDADES  WHERE LABORATORIO_ADICIONALES.id_producto = MATERIAL.material_id and MATERIAL.id_unidad=UNIDADES.id_unidad AND LABORATORIO_ADICIONALES.id_usuario like '%".$search."%' ";

                  if($filter>=0)
                        $sql=$sql." AND LABORATORIO_ADICIONALES.status=".$filter;
          ...
          function cuenta_resultado($search)
          {
                  $search= str_replace(' ', '%', $search);
                 $sql="SELECT
                  LABORATORIO_ADICIONALES.id_laboratorio,
                  LABORATORIO_ADICIONALES.tipo_orden,
                  LABORATORIO_ADICIONALES.id_detalle,
                  LABORATORIO_ADICIONALES.cantidad,
                  LABORATORIO_ADICIONALES.cantidad_rev,
                  LABORATORIO_ADICIONALES.id_usuario,
                  LABORATORIO_ADICIONALES.id_usuario_rev,
                  ...
                  FROM LABORATORIO_ADICIONALES, MATERIAL

                  
                   " ;
                  if(!empty($search))
                  {
                   $sql=$sql."WHERE LABORATORIO_ADICIONALES.id_producto = MATERIAL.material_id  AND LABORATORIO_ADICIONALES.id_usuario like '%".$search."%' OR
                  LABORATORIO_ADICIONALES.id_usuario_rev like '%".$search."%' ";
                  }
