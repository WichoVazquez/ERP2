$(function() {
	$('.delAlm').click(function(e) {e.preventDefault();eliminar($(this),0);});
	$('.editAlm').click(function(e) {e.preventDefault();editar($(this),0);});
	$('#add_almacen').click(function(e) {e.preventDefault();registrar($(this));});
	$( '#dialog' ).dialog({
      autoOpen: false,
      show: {
        effect: "blind",
...
function Pagina(nropagina){
	...
	ajax.open("POST","../Clases/Ajax/busquedaalmacen.php",true);
...
function eliminar(form, ind){
 ...
 if(ind==0){ 
		   ...
		   { 
            ...
            $('<iframe id="sitedel" src="../Clases/Ajax/almacen_eliminar.php?id='+idedit+'" />').dialog({
...
function editar(form, ind){	
 		if(ind==0){ 
		   ...
		   { 
            ...
            $('<iframe id="siteedit" src="almacen_edicion.php?id='+idedit+'" />').dialog({
                open: function(event, ui){ 
        $(this).parents(".ui-dialog:first").find(".ui-widget-header")
            .removeClass("ui-widget-header").addClass("ui-widget-header-custom");
    },
...
function registrar(form){	
            ...
            $('<iframe id="sitedel" src="almacen_registro.php" />').dialog({
                open: function(event, ui){ 
        $(this).parents(".ui-dialog:first").find(".ui-widget-header")
            .removeClass("ui-widget-header").addClass("ui-widget-header-custom");
    },
