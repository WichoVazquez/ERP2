...
function Pagina(nropagina){
	...
	ajax.open("POST","../Clases/Ajax/busquedaremolque.php",true);
...
function eliminar(form, ind){	
 if(ind==0){ 
		   ...
		   { 
            ...
            $('<iframe id="sitedel" src="../Clases/Ajax/remolque_eliminar.php?id='+idedit+'" />').dialog({
...
function editar(form, ind){	
 		if(ind==0){ 
		   ...
		   { 
            ...
            $('<iframe id="siteedit" src="remolque_edicion.php?id='+idedit+'" />').dialog({
                open: function(event, ui){ 
        $(this).parents(".ui-dialog:first").find(".ui-widget-header")
            .removeClass("ui-widget-header").addClass("ui-widget-header-custom");
    },
...
function registrar(form){	
            ...
            $('<iframe id="sitedel" src="remolque_registro.php" />').dialog({
                open: function(event, ui){ 
        $(this).parents(".ui-dialog:first").find(".ui-widget-header")
            .removeClass("ui-widget-header").addClass("ui-widget-header-custom");
    },
