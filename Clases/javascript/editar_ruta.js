...
function Inicio_ImprimeRegistroRuta()
...
console.log("jgbhjgjk"+aDetalle.length);
...
$('#Orden1_ruta').show();
										$( "#Orden1_ruta tbody" ).append( "<tr>" +
												 ...
												 "<td>" +  aDetalle[x][1]+ "</td>" +
													"<td>" +  aDetalle[x][2] + "</td>" +
													"<td>" + fecha_entrega + "</td>" +										
													"<td>"+ " <input type='text' style='width=150px; "+recoleccionOE+"' name='enr"+x+"' id='enr"+x+"' value='" +  aDetalle[x][7]+ "' size='10' width='150'  />" +  "</td>" +		
...
ImprimirOE = "Ver detalle";}
										...
										$( "#Orden1_ruta tbody" ).append( "<tr>" +
												 ...
												 "<td>" +  aDetalle[x][1]+ "</td>" +
													...
													"<td><a href='../Clases/pdf/createorden_salida.php?cot="+aDetalle[x][0]+"' target='_NEW'>" + ImprimirOE + "</a></td>" + 
															"</tr>" );
