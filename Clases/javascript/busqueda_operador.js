// JavaScript Document
$(function() {
	$('.delOperad').click(function(e) {e.preventDefault();eliminar($(this),0);});
	$('.editOperad').click(function(e) {e.preventDefault();editar($(this),0);});
	$('#add_Operador').click(function(e) {e.preventDefault();registrar($(this));});
	$( '#dialog' ).dialog({
      autoOpen: false,
      show: {
        effect: "blind",
...
function Pagina(nropagina){
	...
	ajax.open("POST","../Clases/Ajax/busquedaoperador.php",true);
...
function eliminar(form, ind){	
 if(ind==0){ 
		   ...
		   { 
            ...
            $('<iframe id="sitedel" src="../Clases/Ajax/operador_eliminar.php?id='+idedit+'" />').dialog({
...
function editar(form, ind){	
 		if(ind==0){ 
		   ...
		   { 
            ...
            $('<iframe id="siteedit" src="operador_edicion.php?id='+idedit+'" />').dialog({
                open: function(event, ui){ 
        $(this).parents(".ui-dialog:first").find(".ui-widget-header")
            .removeClass("ui-widget-header").addClass("ui-widget-header-custom");
    },
...
function registrar(form){	
            ...
            $('<iframe id="sitedel" src="operador_registro.php" />').dialog({
                open: function(event, ui){ 
        $(this).parents(".ui-dialog:first").find(".ui-widget-header")
            .removeClass("ui-widget-header").addClass("ui-widget-header-custom");
    },
