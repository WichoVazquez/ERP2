...
$(function() {
   ...
   /*$("#moneda").change(function () {
	...
	$("#quitar-producto" )
      ...
      .button()
      .click(function() {
		  			console.log("ENTRE A GUARDAR: no_orden: "+$( "orde_compra_id" ).val()+"proveedor: "+$( "#proveedor" ).attr("idproveedor")+"usuario: "+$( "#usuario" ).val()+"moneda: "+$( "#moneda" ).val()+"observaciones: "+$("#orden_mensaje").val()+"fecha: "+$("#datepicker").val());

				var msg_compra;
				var arr={
					orden_id: $( "orde_compra_id" ).val(), 
					estado: 1, 
...
function saveProducto(varia){//arr{cotizacion,producto, cantidad, precio}
		//añadir producto a base de datos DETALLE-COTIZACION
			...
			var arr={cotizacion: $( "#cotizacion" ).val(), producto: $( "#producto" ).attr("idproducto"), cantidad: $( "#cantidad" ).val(), precio: $( "#preciobase" ).val(), observaciones: $( "#observaciones" ).val(), multiplo: multip}
...
{
	var msg_cot;
	var arr={cotizacion: $( "#cotizacion" ).val(), estado: 1, cliente: $( "#cliente" ).attr("idcliente"), usuario: $( "#usuario" ).val(),  empresa: $( "#empresa" ).attr("idempresa"), folio:$( "#folio" ).val(), moneda: $( "#moneda" ).val(), cambio_dia: $( "#moneda option:selected" ).attr("tipo_cambio"), observaciones:"" , contacto:$( "#contacto" ).attr("idcontacto"), mensaje:$("#mensaje").val()}
			hilo=$.post(
...
function enviarCotizacion()
{
	var msg_cot;
	var flag=false;
	var arr={cotizacion: $( "#cotizacion" ).val(), estado:2, cliente: $( "#cliente" ).attr("idcliente"), usuario: $( "#usuario" ).val(),  empresa: $( "#empresa" ).attr("idempresa"), folio:$( "#folio" ).val(), moneda: $( "#moneda" ).val(), cambio_dia: $( "#moneda option:selected" ).attr("tipo_cambio"), observaciones:"" , contacto:$( "#contacto" ).attr("idcontacto"), mensaje:$("#mensaje").val()}
			hilo=$.post(
				 '../Clases/Ajax/update_cotizacion.php',
				 JSON.stringify(arr),
				 function(msg) {
